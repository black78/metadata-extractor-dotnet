...
namespace MetadataExtractor.Tests.Formats.Exif
{
    ...
    public sealed class ExifDirectoryTest
    {
        ...
        [Fact]
        public async Task TestGetThumbnailData()
        {
            var directory = await ExifReaderTest.ProcessSegmentBytesAsync<ExifThumbnailDirectory>("withExif.jpg.app1");
        ...
        {
            Xunit.Assert.True(false, "Test was been rewrited.");
            //var directory = ExifReaderTest.ProcessSegmentBytes<ExifThumbnailDirectory>("manuallyAddedThumbnail.jpg.app1");
...
//    }
        ...
        [Fact]
        public async Task TestResolution()
        {
            var directories = await ExifReaderTest.ProcessSegmentBytesAsync("withUncompressedRGBThumbnail.jpg.app1");
