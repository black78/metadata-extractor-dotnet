...
namespace MetadataExtractor.Tests.Formats.Bmp
{
    ...
    {
        [NotNull]
        public static async Task<BmpHeaderDirectory> ProcessBytesAsync([NotNull] string file)
        {
        ...
        [Fact]
        public async Task TestMsPaint16Color()
        {
            var directory = await ProcessBytesAsync("16color-10x10.bmp");
        ...
        [Fact]
        public async Task TestMsPaint24Bpp()
        {
            var directory = await ProcessBytesAsync("24bpp-10x10.bmp");
            Assert.False(directory.HasError);
            Assert.Equal(10, directory.GetInt32(BmpHeaderDirectory.TagImageWidth));
            Assert.Equal(10, directory.GetInt32(BmpHeaderDirectory.TagImageHeight));
